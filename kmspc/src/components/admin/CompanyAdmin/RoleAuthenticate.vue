<template>
  <div>
    ...
    <el-dialog
      :title="$t('authorization.corporate_role')" 
      ...
      <div>
        <div>
          <el-row :gutter="20">
            <el-col :span="6">
              <div>
                <el-input class="input-group" 
                  ...
                  :placeholder="$t('placeholder.department')" size="mini" 
            ...
            <el-col :span="6">
              <div>
                <el-select v-model="params.roleId" :placeholder="$t('placeholder.Please_select_role')" size="mini" @change="onChangeRole" clearable @clear="onClearRole">
        ...
        <div class="roleSelect">
          <el-row :gutter="20">
            ...
            <el-col :span="6">
              <div class="company">
                <div>
                  <el-checkbox label="KMSUPERADMINROLEID">{{$t('admin.enterprise')}}</el-checkbox>
                </div>
              </div>
            </el-col>
            <el-col :span="6">
              <div class="committee">
                <div>
                  <el-checkbox label="KMCOMMITTEEADMINROLEID">{{$t('admin.committee')}}</el-checkbox>
                </div>
              </div>
            </el-col>
            <el-col :span="6">
...
export default {
  ...
  methods:{
    ...
    oncheckedKeys(checkedNodes){
      ...
      params.departmentId = checkedNodes.id;
      params.departmentName = checkedNodes.name;
      this.visiblve = false;
      this.params = params;
      this.getUsersData(params);
    },
