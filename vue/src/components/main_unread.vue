  ...
  <div id="main_pending" v-loading="loading">
    <div class="main_pending-left">
      <div 
        ...
        @click="primaryNavigationSystem" >
        <span>{{preserveObj.name}}</span>
        <a v-if="preserveObj && preserveObj.total > 0" :class="[!currentSelectFlowId?'headNum':'']">
      ...
      <div class="view-list">
        <el-scrollbar class="scrollbar">
          ...
          >
            ...
            <el-table-column :label="$t('profile.status')" align="center">
              <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    //清除$t('placeholder.theme')框和申请框里面面对数据
    eliminating() {
