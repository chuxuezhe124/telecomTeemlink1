<template>
  <div style="height:97%" class="flow-panel-wrap">
    <!--加签主办（协办）-->
    ...
    <div class="flow-wrap" v-else>
      ...
      <div class="refer" v-else>
        ...
        <!--流程启动-->
        <div class="refer-right refer-right-comm" v-if="act.type == 33">
        ...
        <!--流程回退-->
        <div class="refer-right refer-right-comm" v-if="act.type == 47">
        ...
        <div class="refer-right refer-right-comm" v-if="act.type == 48">
        ...
        <!--自由流程结束流程-->
        <div class="refer-right refer-right-comm" v-if="act.type == 52">
          {{$t('view.flow_over')}}
        </div>
      </div>
      ...
      >
        <div v-bind:class="[currentAct ? 'idea' : 'bigIdea', 'common-idea']">
          <div class="idea-left">
            <img src="../assets/images/ic_yj_s.png" width="18px" height="18px" alt="" />
            <span>{{$t('suggest')}}:</span>
          </div>
          <div class="idea-right">
              ...
              <div class="use-suggest" v-if="isOrSuggest">
                ...
                <div class="sug-new" v-if="showEditSecond">
                  ...
                  <div class="keep-cancel">
                    ...
                    <span @click="updateSuggestion">{{$t('form.edit')}}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="idea-opinion">
              ...
              <span @click="changeDiv" class="sug-btn">
                <!-- <img src="../assets/images/qianzi.png" /> -->
                {{$t('view.Hand_signed')}}
                <i class="el-icon-arrow-down"  v-show="currentAct"></i>
                <i class="el-icon-arrow-up"  v-show="!currentAct"></i>
              </span>
            </div>
    ...
    <div class="footer-btn" v-if="act.type != 57 && act.type != 58">
      <div>
        ...
        <span class="pack-up" @click.stop="stowPopup">{{$t('retracting')}}</span>
      </div>
    </div>
    <div class="mask" v-if="isOrSuggest" @click="hiddenSuggest()">
                ...
                if (response.data.errcode == 0) {
                  if (response.data.data) {
                    ...
                    if(!resData.type) { //没有type值，但是有返回数据，把数据放进document
                      ...
                      this.$confirm(this.$t('msg.submit_flow'), this.$t('tip'), {
